            ...
            <ScrollView style={{ flex: 1, }}>
                <ImageBackground
                    ...
                    <View style={GlobalStyles.flexdv}>
                        <TouchableOpacity style={GlobalStyles.leftArrow} onPress={handleGoBack}>
                            <View style={GlobalStyles.arrowBox}><Image source={require('../../../../assets/arrow1.png')} /></View>
                            <Text style={GlobalStyles.titleText}>Partner Master</Text>
                        </TouchableOpacity>
                    ...
                    >
                        <View style={GlobalStyles.modalOverlay}>
                            <View style={GlobalStyles.modalContainer}>
                                ...
                                <Text style={GlobalStyles.mdlSubTitle}>You can add here Partners</Text>
                    ...
                    >
                        <View style={GlobalStyles.modalOverlay}>
                            <View style={GlobalStyles.modalContainer}>
                                ...
                                <Text style={GlobalStyles.mdlSubTitle}>Create Partners or Templates</Text>
